...
<html>
  ...
  <body>
    <h3>Program XML GUI</h3>
    <p>
      This is a simple example of how to access the Program chatbot using the JSON API. Feel free to change the HTML
      code for this page to suit your specific needs. 
    </p>
