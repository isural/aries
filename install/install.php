<?PHP
  ...
  * AUTHOR: Irfan SURAL
  * DATE: 1 July 2015
  * DETAILS: Program Automatic install script
  ***************************************/
  session_name('ARIES_install');
  session_start();
  $thisFile = __FILE__;
  ...
  If ($myPHP_Version < 5.2) $fatalError .= "<p class='red bold'>We're sorry, but Program requires PHP version 5.2 or greater to function. Please ask your hosting provider to upgrade.</p>";
  If (!$pdoSupport) $fatalError .= "<p class='red bold'>Support for PHP Data Objects (PDO) was not detected! This is required for Program to function. Please ask your hosting provider to upgrade.</p>";
...
endWarning;
  ...
  $additionalInfo = <<<endInfo
      <p>
        ...
        have trouble with this, or have questions, please let us know sural@uwm.edu
        .
      </p>
endInfo;
