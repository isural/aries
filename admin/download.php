...
***************************************/
  ...
  $headerTitle = 'Actions:';
  $pageTitle = "ARIES - Download AIML files";
  $mainContent = $content;
  $mainTitle = "Download AIML files for $bot_name ";
...
endRow;
  ...
  function renderMain()
  {
    ...
    if ($file_checkboxes === false) return false;#"<div class=\"bold red center\">$msg</div><br>\n";
    $downForm = $template->getSection('DownloadAIMLForm');
    $content = $template->getSection('DownloadAIMLMain');
    $content = str_replace('[download_content]', $downForm, $content);
