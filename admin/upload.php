...
***************************************/
  ...
  $AIMLList = $template->getSection('UploadAIMLList');
  ...
  $headerTitle = 'Actions:';
  $pageTitle = 'ARIES - Upload AIML';
  $mainContent = $template->getSection('UploadMain');
  $mainTitle = "Upload AIML to use for $bot_name";
  ...
  $mainContent = str_replace('[AIMLList]', $AIMLList, $mainContent);
  ...
  */
  function parseAIML($fn, $aimlContent, $from_zip = false)
  {
    ...
    $validAIMLHeader = '<?xml version="1.0" encoding="[charset]"?>
		<!DOCTYPE aiml PUBLIC "-//W3C//DTD Specification Version 1.0//EN" "http://irfansural.com/aries/xml/aiml.dtd">
